...
#ifndef _INPUT_MUTIL_MODAL_IMAGE_LIST_ITERATOR_H_
#define _INPUT_MUTIL_MODAL_IMAGE_LIST_ITERATOR_H_

#include <string>

#include "data_iterator.h"

class MutilModalImageListDataIterator : public DataIterator {
 public:
  MutilModalImageListDataIterator() : DataIterator("mutil_modal_image_list_data_iterator") {}
  ...
  */
  ...
  ~MutilModalImageListDataIterator();
