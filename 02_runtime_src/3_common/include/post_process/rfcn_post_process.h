...
#ifndef _POST_PROCESS_RFCN_POST_PROCESS_H_
#define _POST_PROCESS_RFCN_POST_PROCESS_H_
...
class RfcnPostProcessModule : public PostProcessModule {
 public:
  explicit RfcnPostProcessModule(std::string instance_name)
      : PostProcessModule("rfcn_post_process", instance_name) {}
...
#endif  // _POST_PROCESS_RFCN_POST_PROCESS_H_
